...
export default function ProjectDetailLoading() {
  return (
    <div className="space-y-6">
      ...
      {/* Section skeletons */}
      {[1, 2, 3].map((i) => (
        <div key={i} className="bg-[var(--color-surface-raised)] rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-[var(--color-border-default)] flex items-center gap-3">
