            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 glass-card-elevated rounded-xl flex items-center justify-center flex-shrink-0">
                    <IconMail className="w-6 h-6 text-[var(--color-text-secondary)]" />
                  </div>
                  <div>
                    ...
                    <a
                      ...
                      className="text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] hover:underline mt-2 inline-block"
                    >
                      hello@rankriot.app
                    </a>
                  </div>
                ...
                {/*<div className="flex gap-4">*/}
                {/*  <div className="w-12 h-12 glass-card-elevated rounded-xl flex items-center justify-center flex-shrink-0">*/}
                {/*    <IconBrandTwitter className="w-6 h-6 text-[var(--color-text-secondary)]" />*/}
                {/*  </div>*/}
                {/*  <div>*/}
                {/*    <h3 className="font-semibold text-[var(--color-text-primary)]">Twitter</h3>*/}
                {/*    <p className="text-[var(--color-text-secondary)] mt-1">*/}
                ...
                {/*<div className="flex gap-4">*/}
                {/*  <div className="w-12 h-12 glass-card-elevated rounded-xl flex items-center justify-center flex-shrink-0">*/}
                {/*    <IconBrandGithub className="w-6 h-6 text-[var(--color-text-secondary)]" />*/}
                {/*  </div>*/}
                {/*  <div>*/}
                {/*    <h3 className="font-semibold text-[var(--color-text-primary)]">GitHub</h3>*/}
                {/*    <p className="text-[var(--color-text-secondary)] mt-1">*/}
